  ...
  <div id="menu-css">
	<ul>
  	...
  	<s:if test="user.authLevel==@org.sourcelesslight.model.enums.AuthType@USER">
  		<script>
			$(function(){
  	...
  	<s:elseif test="user.authLevel==@org.sourcelesslight.model.enums.AuthType@ADMIN">
  		<script>
			$(function(){
				$("div.menu-wrapper,div.content-wrapper,div.copyright-wrapper").css("background","rgba(255,150,0,0.6)");
			});
  	...
  	<s:elseif test="user.authLevel==@org.sourcelesslight.model.enums.AuthType@MODERATOR">
  	...
  	<s:if test="user.userId > 0">
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}<s:text name="format.theme">
